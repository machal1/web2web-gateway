  ...
  render: function() {
    return (
      <div>
        ...
        <p>Your webpage should be one single html file.</p>
        ...
        <p>
          ...
          <br />
          This is the hard part. You'll have to do it manually (there's a <a href="http://www.alexleishman.com/posts/op-return-transactions">ruby script</a> to get you started).
        </p>

        <h3>5. Even better magic!</h3>
        <p>
